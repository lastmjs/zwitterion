...
//         const compiledToJS = compileToJs({
//             source, 
//             target, 
...
//             compiledFiles[params.filePath] = null;
...
//     webSocketPort: number;
//     watchFiles: boolean;
// }): Readonly<WebSocket.Server> | null {
//     if (params.watchFiles) {

//         const webSocketServer = new WebSocket.Server({
//             port: params.webSocketPort
//         });
...
// TODO keeping around for Wasm integration
...
//     if (await fs.exists(nodeFilePath)) {
//         watchFile(nodeFilePath, watchFiles);
//         const sourceBuffer: Readonly<Buffer> = await fs.readFile(nodeFilePath);
...
// TODO keeping around for Wast support
...
// TODO keeping this around until WASM integration is complete
// async function compileToWASMBuffer(source) {
//     return (await wast2wasm(source)).buffer;
// }

// TODO keeping this around until WASM integration is complete
// function wrapWASMInJS(sourceBuffer: Readonly<Buffer>): JavaScript {
//     return `
...
// TODO prepare to delete this...keeping it here in case we want to implement this feature again
// function getTypeScriptErrorsString(filePath: string, tsWarning, tsError) {
