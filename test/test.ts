...
(async () => {
    ...
    const chromeCommand: 'chrome' | 'google-chrome' = process.env.OS === 'ubuntu-latest' ? 'google-chrome' : process.env.OS === 'macos-latest' ? 'open /Applications/Google\ Chrome.app' : 'start chrome';
