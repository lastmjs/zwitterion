// Modified by Jordan Last
// Taken from https://github.com/AssemblyScript/assemblyscript/blob/master/lib/loader/index.js

// Licensed under Apache License 2.0: https://github.com/AssemblyScript/assemblyscript/blob/master/LICENSE
// NOTICE: https://github.com/AssemblyScript/assemblyscript/blob/master/NOTICE

// The LICENSE and NOTICE files are also included in the same directory as this file in the Zwitterion project

export const loaderString: string = `
    "use strict";
